                    ...
                    GestureDetector(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: const Text("Fillter Trasaction" , style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                                    ),
                                    //button reset
                                    Container(
                                ...
                                Padding(
                                  ...
                                  child: Text("Filter By", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                ),
                                Row(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text("Choose category", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                      Row(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: Color.fromARGB(255, 193, 191, 191))
                        ),
                        child: Image.asset('lib/icons/sort.png')
                      ),
                    )
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          height: 60,
                          child: Image.asset('lib/icons/shopping.png'),
                          decoration: BoxDecoration(
                            color: Colors.amber,
                            shape: BoxShape.rectangle,
                    ...
                    child: Row(
                      children: [
                        Container(
                          padding: EdgeInsets.all(15),
                          height: 60,
                          child: Image.asset('lib/icons/subcription.png'),
                          decoration: BoxDecoration(
                            color: Colors.purple[100],
                            shape: BoxShape.rectangle,
                            borderRadius: BorderRadius.circular(10)
                    ...
                    child: Row(
                      children: [
                        Container(
                          padding: EdgeInsets.all(15),
                          height: 60,
                          child: Image.asset('lib/icons/food.png'),
                          decoration: BoxDecoration(
                    ...
                    child: Row(
                      children: [
                        Container(
                          padding: EdgeInsets.all(15),
                          height: 60,
                          child: Image.asset('lib/icons/money.png'),
                          decoration: BoxDecoration(
                    ...
                    child: Row(
                      children: [
                        Container(
                          padding: EdgeInsets.all(15),
                          height: 60,
                          child: Image.asset('lib/icons/transport.png'),
                          decoration: BoxDecoration(
